...
- An optional `harvestUrl` property that would be used to fetch files through a remote HTML directory index on a `harvest` request 
  as well as right before adding an uploaded file to the queue through an `upload` request.
- An optional `lastHarvested` date property. It is system maintained, but the system setting can be overwritten by 
  an operator, for example to back-date it in order to retry a harvest from an earlier point in time. 
...
| API                                                                                                                                                                            | Feature                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| POST <nobr>`/inventory-import/channels`</nobr><br/>Properties:<br/>`name`<br/>`tag`<br/>`transformationId`<br/>`enabled`<br/>`listening`<br/>`harvestUrl`<br/>`lastHarvested`  | Create a channel. A transformation pipeline must be created, that the channel can reference, before the channel can be created. <br/>The `tag` can be used instead of the channels UUID in some API requests.<br/>If `enabled` is `true` the channel will accept uploads.<br/>If `listening` is true, the channel will process uploaded files (in order of arrival).<br/>If `harvesturl` is defined it will be used in `harvest` requests and in `upload` requests. `lastHarvested` is a system maintained date, though it can be overwritten.                                                                                                                                                                                            |

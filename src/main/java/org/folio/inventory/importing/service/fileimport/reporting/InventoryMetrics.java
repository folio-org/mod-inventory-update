package org.folio.inventory.importing.service.fileimport.reporting;
...
import static org.folio.inventory.importing.service.fileimport.reporting.InventoryMetrics.Entity.INSTANCE;
import static org.folio.inventory.importing.service.fileimport.reporting.InventoryMetrics.Entity.HOLDINGS_RECORD;
import static org.folio.inventory.importing.service.fileimport.reporting.InventoryMetrics.Entity.ITEM;
import static org.folio.inventory.importing.service.fileimport.reporting.InventoryMetrics.Transaction.CREATE;
import static org.folio.inventory.importing.service.fileimport.reporting.InventoryMetrics.Transaction.DELETE;
import static org.folio.inventory.importing.service.fileimport.reporting.InventoryMetrics.Transaction.UPDATE;
import static org.folio.inventory.importing.service.fileimport.reporting.InventoryMetrics.Transaction.PROVISIONAL_INSTANCE;
import static org.folio.inventory.importing.service.fileimport.reporting.InventoryMetrics.Outcome.COMPLETED;
import static org.folio.inventory.importing.service.fileimport.reporting.InventoryMetrics.Outcome.FAILED;
import static org.folio.inventory.importing.service.fileimport.reporting.InventoryMetrics.Outcome.SKIPPED;

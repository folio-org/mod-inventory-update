...
public class MainVerticle extends AbstractVerticle {
  ...
  public static final String CACHED_REFERENCE_DATA_MAPPINGS_PATH = "/inventory-upsert/cached-reference-data-mappings";
  ...
  public void start(Promise<Void> promise)  {
    ...
    router.get(CACHED_REFERENCE_DATA_MAPPINGS_PATH).handler(ReferenceDataMappings::handleGet);
    router.delete(CACHED_REFERENCE_DATA_MAPPINGS_PATH).handler(ReferenceDataMappings::handleClear);

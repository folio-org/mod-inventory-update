...
public class InventoryUpdateOverOkapiClient extends InventoryUpdateClient {
    ...
    private static InventoryUpdateOverOkapiClient inventoryUpdateClient;
    public static final Logger logger = LogManager.getLogger("InventoryUpdateClient");


    private InventoryUpdateOverOkapiClient(RoutingContext routingContext) {
        okapiClient = Folio.okapiClient(routingContext);
    }

    public static InventoryUpdateOverOkapiClient getClient (RoutingContext routingContext) {
        if (inventoryUpdateClient == null) {
            inventoryUpdateClient = new InventoryUpdateOverOkapiClient(routingContext);
        }

...
import org.folio.inventory.updating.MainVerticle;
import org.folio.inventory.updating.test.fakestorage.FakeFolioApis;
import org.folio.inventory.updating.test.fakestorage.RecordStorage;
...
public abstract class InventoryUpdateTestBase {
  ...
  public static final String CREATE = org.folio.inventory.updating.entities.InventoryRecord.Transaction.CREATE.name();
  public static final String UPDATE = org.folio.inventory.updating.entities.InventoryRecord.Transaction.UPDATE.name();
  public static final String DELETE = org.folio.inventory.updating.entities.InventoryRecord.Transaction.DELETE.name();

  public static final String COMPLETED = org.folio.inventory.updating.entities.InventoryRecord.Outcome.COMPLETED.name();
  public static final String FAILED = org.folio.inventory.updating.entities.InventoryRecord.Outcome.FAILED.name();
  public static final String SKIPPED = org.folio.inventory.updating.entities.InventoryRecord.Outcome.SKIPPED.name();

  public static final String HOLDINGS_RECORD = org.folio.inventory.updating.entities.InventoryRecord.Entity.HOLDINGS_RECORD.name();
  public static final String INSTANCE = org.folio.inventory.updating.entities.InventoryRecord.Entity.INSTANCE.name();
  public static final String ITEM = org.folio.inventory.updating.entities.InventoryRecord.Entity.ITEM.name();
  public static final String INSTANCE_TITLE_SUCCESSION = org.folio.inventory.updating.entities.InventoryRecord.Entity.INSTANCE_TITLE_SUCCESSION.name();
  public static final String INSTANCE_RELATIONSHIP = org.folio.inventory.updating.entities.InventoryRecord.Entity.INSTANCE_RELATIONSHIP.name();

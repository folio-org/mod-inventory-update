...
public class StorageValidatorHoldingsRecords {
    ...
    protected void validatePostAndGetById(TestContext testContext) {
        ...
        JsonObject responseOnGET = FakeFolioApisForImporting.getRecordById(HOLDINGS_STORAGE_PATH, responseOnPOST.getString("id"));
    ...
    protected void validateGetByQueryAndPut(TestContext testContext) {
        ...
        FakeFolioApisForImporting.put(HOLDINGS_STORAGE_PATH, existingRecord);
        JsonObject holdingsRecord = FakeFolioApisForImporting.getRecordById(HOLDINGS_STORAGE_PATH, existingRecord.getString("id"));
    ...
    protected void validateCanDeleteHoldingsRecordById (TestContext testContext) {
        ...
        FakeFolioApisForImporting.delete(HOLDINGS_STORAGE_PATH, responseOnPOST.getString("id"),200);
    }

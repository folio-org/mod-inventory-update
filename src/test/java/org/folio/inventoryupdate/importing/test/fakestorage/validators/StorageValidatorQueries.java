...
import static org.folio.inventoryupdate.importing.test.fakestorage.FakeFolioApisForImporting.RESULT_SET_INSTANCES;
...
public class StorageValidatorQueries
{
    ...
    protected void validateMatchKeyQuery (TestContext testContext) {
        ...
        JsonObject responseOnQueryWithMatch = FakeFolioApisForImporting.getRecordsByQuery(INSTANCE_STORAGE_PATH,
        ...
        JsonObject responseOnQueryWithOutMatch = FakeFolioApisForImporting.getRecordsByQuery(INSTANCE_STORAGE_PATH,
    ...
    protected void validateOrQuery (TestContext testContext) {
        ...
        JsonObject responseOnOrQuery = FakeFolioApisForImporting.getRecordsByQuery(INSTANCE_STORAGE_PATH,
    ...
    protected void validateIdentifierQuery (TestContext testContext) {
        ...
        JsonObject responseOnIdentifierQuery = FakeFolioApisForImporting.getRecordsByQuery( INSTANCE_STORAGE_PATH,
    ...
    protected void validateEqualityAndNotEqualityQuery (TestContext testContext) {
        JsonObject responseOnNotQuery1 = FakeFolioApisForImporting.getRecordsByQuery(INSTANCE_STORAGE_PATH,
        ...
        JsonObject responseOnNotQuery2 = FakeFolioApisForImporting.getRecordsByQuery(INSTANCE_STORAGE_PATH,

...
import static org.folio.inventoryupdate.test.fakestorage.entitites.TestInstanceTitleSuccession.*;
...
public class StorageValidatorPrecedingSucceeding  {
    ...
    protected void validatePostAndGetById(TestContext testContext) {
        JsonObject responseOnPOST = FakeInventoryStorage.post(
                ...
                new TestInstanceTitleSuccession().setSucceedingInstanceId(succeedingInstanceId).setPrecedingInstanceId(precedingInstanceId).getJson());

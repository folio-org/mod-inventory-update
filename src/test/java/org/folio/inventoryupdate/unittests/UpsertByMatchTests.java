...
public class UpsertByMatchTests extends InventoryUpdateTestBase {
  ...
  public void upsertByMatchKeyWillCreateNewInstance (TestContext testContext) {
    ...
    JsonObject instancesBeforePutJson = getRecordsFromStorage(FakeFolioApisForImporting.INSTANCE_STORAGE_PATH, "matchKey==\"" + matchKey.getKey() + "\"");
    ...
    JsonObject instancesAfterPutJson = getRecordsFromStorage(FakeFolioApisForImporting.INSTANCE_STORAGE_PATH, "matchKey==\"" + matchKey.getKey() + "\"");
  ...
  public void batchUpsertByMatchKeyWillCreate200NewInstances (TestContext testContext) {
    ...
    JsonObject instancesBeforePutJson = getRecordsFromStorage(FakeFolioApisForImporting.INSTANCE_STORAGE_PATH, null);
    ...
    batchUpsertByMatchKey(batch.getJson());
    JsonObject instancesAfterPutJson = getRecordsFromStorage(FakeFolioApisForImporting.INSTANCE_STORAGE_PATH, null);
  ...
  public void batchByMatchKeyWithMultipleLowLevelProblemsWillRespondWithMultipleErrors (TestContext testContext) {
    ...
    JsonObject instances = getRecordsFromStorage(FakeFolioApisForImporting.INSTANCE_STORAGE_PATH, null);
    testContext.assertEquals(instances.getInteger("totalRecords"), 5,
        "The batch upsert should create five Instances");
    JsonObject holdings = getRecordsFromStorage(FakeFolioApisForImporting.HOLDINGS_STORAGE_PATH, null);
    testContext.assertEquals(holdings.getInteger("totalRecords"), 8,
        "The batch upsert should create eight holdings records");
    JsonObject items = getRecordsFromStorage(FakeFolioApisForImporting.ITEM_STORAGE_PATH, null);
  ...
  public void upsertByMatchKeyWillCreateHoldingsAndItems(TestContext testContext) {
    ...
    JsonObject storedHoldings = getRecordsFromStorage(FakeFolioApisForImporting.HOLDINGS_STORAGE_PATH, "instanceId==\"" + instanceId + "\"");
    ...
    JsonObject storedItems = getRecordsFromStorage(FakeFolioApisForImporting.ITEM_STORAGE_PATH, null);
  ...
  public void upsertByMatchKeyWillUpdateHoldingsAndItems (TestContext testContext) {
    ...
    getRecordsFromStorage(FakeFolioApisForImporting.ITEM_STORAGE_PATH,null).getJsonArray("items").stream()
  ...
  public void upsertsByMatchKeyWillCreateSharedInstanceFromTwoInstitutionsAndDeleteByOaiIdentifier (TestContext testContext) {
    ...
    JsonObject instanceFromStorage = getRecordFromStorageById(FakeFolioApisForImporting.INSTANCE_STORAGE_PATH, instanceId);
    ...
    storedHoldings = getRecordsFromStorage(FakeFolioApisForImporting.HOLDINGS_STORAGE_PATH, "instanceId==\"" + instanceId + "\"");
    ...
    storedItems = getRecordsFromStorage(FakeFolioApisForImporting.ITEM_STORAGE_PATH, null);
    ...
    instanceFromStorage = getRecordFromStorageById(FakeFolioApisForImporting.INSTANCE_STORAGE_PATH, instanceId);
  ...
  public void upsertByShiftingMatchKeyWillCleanUpRecordsForPreviousMatchKey( TestContext testContext) {
    ...
    JsonObject storedHoldingsSameRecordNewInstance = getRecordsFromStorage(FakeFolioApisForImporting.HOLDINGS_STORAGE_PATH, "instanceId==\"" + instanceIdSameRecordNewMatchKey + "\"");
    ...
    JsonObject allStoredItems = getRecordsFromStorage(FakeFolioApisForImporting.ITEM_STORAGE_PATH, null);
    ...
    JsonObject newInstanceFromStorage = getRecordFromStorageById(FakeFolioApisForImporting.INSTANCE_STORAGE_PATH, instanceIdSameRecordNewMatchKey);
    ...
    JsonObject oldInstanceFromStorage = getRecordFromStorageById( FakeFolioApisForImporting.INSTANCE_STORAGE_PATH, instanceId );
    ...
    JsonObject previousInstanceStoredHoldings = getRecordsFromStorage(FakeFolioApisForImporting.HOLDINGS_STORAGE_PATH, "instanceId==\"" + instanceId + "\"");
  ...
  public void testUpsertByMatchKeyWithEmptyLocationsTable (TestContext testContext) {
    RestAssured.given()
        ...
        .delete(FakeFolioApisForImporting.LOCATION_STORAGE_PATH)
        .then()

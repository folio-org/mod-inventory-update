...
public class StorageValidatorPoLines {
  ...
  protected void validatePostAndGetById(TestContext testContext) {
    JsonObject responseOnPOST = FakeFolioApisForImporting.post(
        FakeFolioApisForImporting.ORDER_LINES_STORAGE_PATH,
    ...
    JsonObject responseOnGET = FakeFolioApisForImporting.getRecordById(FakeFolioApisForImporting.ORDER_LINES_STORAGE_PATH, responseOnPOST.getString("id"));

...
public class StorageValidatorHoldingsRecords {
    ...
    protected void validatePostAndGetById(TestContext testContext) {
        ...
        JsonObject responseOnGET = FakeFolioApisForUpserts.getRecordById(HOLDINGS_STORAGE_PATH, responseOnPOST.getString("id"));
    ...
    protected void validateGetByQueryAndPut(TestContext testContext) {
        ...
        FakeFolioApisForUpserts.put(HOLDINGS_STORAGE_PATH, existingRecord);
        JsonObject holdingsRecord = FakeFolioApisForUpserts.getRecordById(HOLDINGS_STORAGE_PATH, existingRecord.getString("id"));
    ...
    protected void validateCanDeleteHoldingsRecordById (TestContext testContext) {
        ...
        FakeFolioApisForUpserts.delete(HOLDINGS_STORAGE_PATH, responseOnPOST.getString("id"),200);
    }

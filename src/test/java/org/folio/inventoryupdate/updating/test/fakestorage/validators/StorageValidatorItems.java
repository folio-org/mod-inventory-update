...
import static org.folio.inventoryupdate.updating.test.InventoryUpdateTestBase.MATERIAL_TYPE_TEXT;
import static org.folio.inventoryupdate.updating.test.InventoryUpdateTestBase.STATUS_UNKNOWN;
...
public class StorageValidatorItems {
    ...
    protected void createInstanceAndHoldings() {
        JsonObject responseOnInstancePOST = FakeFolioApisForUpserts.post(
        ...
        JsonObject responseOnHoldingsPOST = FakeFolioApisForUpserts.post(
    ...
    protected void validatePostAndGetById(TestContext testContext) {
        ...
        JsonObject responseOnGET = FakeFolioApisForUpserts.getRecordById(ITEM_STORAGE_PATH, responseOnPOST.getString("id"));
    ...
    protected void validateGetByQueryAndPut(TestContext testContext) {
        ...
        FakeFolioApisForUpserts.put(ITEM_STORAGE_PATH, existingRecord);
        JsonObject item = FakeFolioApisForUpserts.getRecordById(ITEM_STORAGE_PATH, existingRecord.getString("id"));
    ...
    protected void validateCanDeleteItemById (TestContext testContext) {
        ...
        FakeFolioApisForUpserts.delete(ITEM_STORAGE_PATH, responseOnPOST.getString("id"),200);
    }

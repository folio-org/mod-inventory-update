...
import static org.folio.inventoryupdate.updating.test.fakestorage.FakeFolioApisForUpserts.RESULT_SET_INSTANCES;
...
public class StorageValidatorQueries
{
    ...
    protected void validateMatchKeyQuery (TestContext testContext) {
        ...
        JsonObject responseOnQueryWithMatch = FakeFolioApisForUpserts.getRecordsByQuery(INSTANCE_STORAGE_PATH,
        ...
        JsonObject responseOnQueryWithOutMatch = FakeFolioApisForUpserts.getRecordsByQuery(INSTANCE_STORAGE_PATH,
    ...
    protected void validateOrQuery (TestContext testContext) {
        ...
        JsonObject responseOnOrQuery = FakeFolioApisForUpserts.getRecordsByQuery(INSTANCE_STORAGE_PATH,
    ...
    protected void validateIdentifierQuery (TestContext testContext) {
        ...
        JsonObject responseOnIdentifierQuery = FakeFolioApisForUpserts.getRecordsByQuery( INSTANCE_STORAGE_PATH,
    ...
    protected void validateEqualityAndNotEqualityQuery (TestContext testContext) {
        JsonObject responseOnNotQuery1 = FakeFolioApisForUpserts.getRecordsByQuery(INSTANCE_STORAGE_PATH,
        ...
        JsonObject responseOnNotQuery2 = FakeFolioApisForUpserts.getRecordsByQuery(INSTANCE_STORAGE_PATH,
